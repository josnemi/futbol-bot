...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'lang_en':
        ...
        n = chr(10)
        welcome_text = "⚽ ELITE ANALYSIS HUB" + n + n + "📊 Daily football statistics and data-driven analysis." + n + "🏆 Premier League, La Liga, Champions League coverage." + n + n + "🎯 HOW TO ACCESS VIP MODEL OUTPUTS:" + n + "1️⃣ Register on our partner platform using the link below." + n + "2️⃣ Complete your first transaction (Minimum 500 BDT)." + n + "3️⃣ Return here and click Registered." + n + "4️⃣ Type your Partner Site ID in this chat." + n + "5️⃣ Our team will verify within 24 hours and send your private access link." + n + n + "🔗 LINK: " + REFERRAL_LINK + n + n + "⚠️ Important: Registration alone is not enough. Approval is given only after the first transaction is completed."
        if WELCOME_IMAGE_URL:
