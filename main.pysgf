...
def registered_keyboard_bn():
    return InlineKeyboardMarkup([[InlineKeyboardButton("Registered - Send ID", callback_data='registered')]])
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'lang_en':
        add_user(user.id, user.username or "", user.first_name or "", "en")
        n = chr(10)
        welcome_text = "WELCOME TO THE ELITE ANALYSIS HUB" + n + n + "Daily football statistics and data-driven predictions." + n + "Premier League, La Liga, Champions League coverage." + n + n + "HOW TO ACCESS VIP MODEL OUTPUTS:" + n + "1. Register on our partner platform using the link below." + n + "2. Complete your first transaction (Minimum 500 BDT)." + n + "3. Return here and click I Registered." + n + "4. Type your Partner Site ID in this chat." + n + "5. Our team will verify within 24 hours and send your private access link." + n + n + "LINK: " + REFERRAL_LINK + n + n + "Important: Registration alone is not enough. Approval is given only after the first transaction is completed."
        ...
        n = chr(10)
        welcome_text = "ELITE ANALYSIS HUB" + n + n + "Daily football statistics and data-driven analysis." + n + "Premier League, La Liga, Champions League coverage." + n + n + "HOW TO ACCESS VIP MODEL OUTPUTS:" + n + "1. Register on our partner platform using the link below." + n + "2. Complete your first transaction (Minimum 500 BDT)." + n + "3. Return here and click Registered." + n + "4. Type your Partner Site ID in this chat." + n + "5. Our team will verify within 24 hours and send your private access link." + n + n + "LINK: " + REFERRAL_LINK + n + n + "Important: Registration alone is not enough. Approval is given only after the first transaction is completed."
        if WELCOME_IMAGE_URL:
...
async def approve(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        n = chr(10)
        if lang == 'bn':
            msg = "Your ID has been approved!" + n + n + "SECURITY RULES:" + n + "- This link is for YOU only." + n + "- It can only be used ONCE." + n + "- Use it within 1 hour or it will expire." + n + "- If you share it with someone else, THEY will enter, YOU will not." + n + n + "YOUR VIP LINK:" + n + invite_link.invite_link + n + n + "Click quickly and join the channel!"
        else:
            msg = "Your ID has been approved!" + n + n + "SECURITY RULES:" + n + "- This link is for YOU only." + n + "- It can only be used ONCE." + n + "- Use it within 1 hour or it will expire." + n + "- If you share it with someone else, THEY will enter, YOU will not." + n + n + "YOUR VIP LINK:" + n + invite_link.invite_link + n + n + "Click quickly and join the channel!"
